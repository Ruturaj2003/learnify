...
const DashboardPage = () => {
  ...
  const removeBook = (index: number) => {
    ...
    // If the removed book is the current book, reset the current book index
    ...
    <div className="min-h-screen bg-gray-100 mb-16">
      ...
      <main className="max-w-5xl mx-auto p-4 sm:p-6">
        ...
        <section className="bg-white shadow-md rounded-lg p-6 mb-8">
          ...
          <p className="text-xl text-gray-800 mb-4">{currentBook.title}</p>
          <div className="mb-4">
          ...
          <div>
            <h3 className="text-lg font-medium text-gray-700">
              Knowledge Score: {currentBook.knowledgeScore}/100
            </h3>
          </div>
        </section>
